...
default[:oracle][:rdbms12c][:dbs] = {'db1' => false}
# The directory under which we install the DBs.
default[:oracle][:rdbms12c][:dbs_root] = "/oradata"

# Local emConfiguration
# Attributes for the local database dbcontrol for all databases.
default[:oracle][:rdbms12c][:dbconsole][:emconfig] = false
#default[:oracle12cdb][:rdbms12c][:dbconsole][:emconfig] = true
default[:oracle][:rdbms12c][:dbconsole][:sysman_pw] = 'sysman_pw_goes_here'
default[:oracle][:rdbms12c][:dbconsole][:notification_email] = 'foo@bar.inet'
default[:oracle][:rdbms12c][:dbconsole][:outgoing_mail] = 'mailhost'
